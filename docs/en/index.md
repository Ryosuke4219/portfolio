...
<div class="demo-grid">
  ...
  <article class="demo-card">
    ...
    <ul>
      ...
      <li>Launch batch comparisons via <code>python adapter/run_compare.py --prompts projects/04-llm-adapter/examples/prompts/ja_one_liner.jsonl</code> to audit the Japanese one-liner JSONL prompts.</li>
    </ul>
...
- `python adapter/run_compare.py --prompts projects/04-llm-adapter/examples/prompts/ja_one_liner.jsonl` records comparison metrics for the Japanese one-liner JSONL prompts.
