"""Payload construction helpers for the Ollama provider."""
...
def prepare_chat_payload(request: ProviderRequest, model_name: str) -> tuple[dict[str, Any], float | None]:
    """Prepare the chat payload and timeout overrides for the request."""

    messages_payload = _build_messages(request)
    ...
    timeout_override = _apply_request_options(request, payload, options_payload)
