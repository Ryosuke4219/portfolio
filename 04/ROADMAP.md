...
| **M3 — Providers** | Week42: 10-13〜10-19 | 実プロバイダ実装 | Simulated/OpenAI/Gemini登録 / ストリーミング透過 / 契約テスト | 🟡 進行中（残タスク: OpenRouter 429/5xx エラー統計を継続集計し、バックオフ/RPM 調整指針を確立する[^provider-registry]） |
